...
int main(int argc, char *argv[])
{
	...
	i_G2 = 2 * i_NC + 100;
	dbg("i_G2 = %0x\n", i_G2);
	set_value_8(0x040a0eae, 0x040a0eae, G2);
	printf("G2 is: ");
	for(i = 0; i < 8; i++)
	    printf("%02x", G2[i]);
	printf("\n");
	...
	set_value_8(0x7d1e74cc, 0x98965144, G3);
	printf("G3 is: ");
	for(i = 0; i < 8; i++)
	    printf("%02x", G3[i]);
	printf("\n");
	...
	srandom(now_time * 2);
	i_Tmp2 = random() + now_time * 2;
	set_value_8(0xab023172, 0x98965144, zone0);
	printf("zone0 is :");
	for(i = 0; i < 8; i++)
	    printf("%02x", zone0[i]);
	printf("\n");
	...
	set_value_8(0x58a3f998, 0xb4e409f5, zone1);
	printf("zone1 is :");
	for(i = 0; i < 8; i++)
	    printf("%02x", zone1[i]);
	printf("\n");
	...
	set_value_8(0x46b00c58, 0x477a896a, zone2);
	printf("zone2 is :");
	for(i = 0; i < 8; i++)
	    printf("%02x", zone2[i]);
	printf("\n");
	...
	set_value_8(0xb42c62c2, 0x36c8c451, zone3);
	printf("zone3 is :");
	for(i = 0; i < 8; i++)
	    printf("%02x", zone3[i]);
	printf("\n");
