...
Usage: $0 DEVICE BOOTLOADER
  ...
  DEVICE: The SD card device to install the SmartQ Qi bootloader, for example
          "/dev/sdb". Be sure to pass the right device name.

  BOOTLOADER: Location of the compiled Qi bootloader file.

The SmartQ Qi bootloader is written to the end of the SD card. When
